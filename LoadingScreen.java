//************************************************************************
// File: LoadingScreen.java           CPSC-112 CLASS PROJECT
// 
// Author: Hanah Leventhal		     	  Email: hanah.leventhal@yale.edu
//
// Class: LoadingScreen
// Dependencies: AutoSongGenerator
//
//   --------------------
//   
...
//    AutoSongGenerator playFile method when it reaches 100.
//
//************************************************************************
...
public class LoadingScreen {
  ...
  public static JFrame loadingScreenGUI(JFrame frame, int selectedTempo, int selectedKeySig, int selectedTimeSig, JTextField fileNameInput, String musicFileName) {
		// Clear frame
    ...
    // Page title
    JLabel title = new JLabel("<html><ceneter>Generating Song...</center></html>", SwingConstants.CENTER){
    ...
    timer.scheduleAtFixedRate(new TimerTask()
        {
            public void run(){
                if (progressBar.getValue() == 100) {
                    ...
                    boolean songIsGenerating = true;
                    while (songIsGenerating) {
                      generatedSongMap = GeneratorAI.songGenerator(selectedTempo, selectedKeySig, selectedTimeSig);
                      songIsGenerating = false;
                    }
                    progressBar.setValue(100);
                    JFrame frame2;
                    frame2 = AutoSongGenerator.generatedSongGUI(frame, generatedSongMap, fileNameInput, musicFileName);
                    AutoSongGenerator.autoModeGUI(frame2);
                    count = 0;
                    progressBar.setValue(0);
                    timer.cancel();
                }
